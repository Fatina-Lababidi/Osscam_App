...
class BugsPage extends StatefulWidget {
  BugsPage({super.key, required this.bugId, required this.hasBugs, this.post});
  final int bugId;
  final bool hasBugs;
              ...
              Center(
                child: Container(
                  ...
                  child: (widget.hasBugs)
                      ...
                      : const Text(""), //widget.comment
                ),
              ).animate().fade(delay: 1.1.seconds, duration: 1.seconds),
          SizedBox(
            height: screenHeight * 0.03,
          ),
          const Divider(
