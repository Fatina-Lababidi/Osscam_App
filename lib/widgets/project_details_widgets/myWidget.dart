      ...
      children: [
        DraggableColumn(
          ...
          widgetItems: newTasks
              .map((task) => ItemWidget(task, widget.showCardFouced,AppColors.cardPurpleColor,AppColors.backingTextColor,"Backing"))
              .toList(),
          status: "Backing",
        ...
        DraggableColumn(
          ...
          widgetItems: onProgressTasks
              .map((e) => ItemWidget(e, widget.showCardFouced,AppColors.cardApricotColor,AppColors.progressTextColor,"on progress"))
              .toList(),
          status: "on progress",
        ...
        DraggableColumn(
          ...
          widgetItems: doneTasks
              .map((e) => ItemWidget(e, widget.showCardFouced,AppColors.cardGreenColor,AppColors.doneTextColor,"Done"))
              .toList(),
          status: "Done",
