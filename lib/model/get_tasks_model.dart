...
class GetAllTasks {
  ...
  @override
  String toString() {
    return 'GetAllTasks( taskId: $taskId,taskDescription: $taskDescription, taskStatus: $taskStatus)';
    //project_id: $project_id
  }
  ...
  @override
  int get hashCode {
    return taskId.hashCode ^ taskDescription.hashCode ^ taskStatus.hashCode;
    // project_id.hashCode;
  }
}
